 ...
 */
final class Version20210425125358 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE attributes (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, product_id INTEGER DEFAULT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, type VARCHAR(64) NOT NULL COLLATE BINARY, label VARCHAR(255) NOT NULL COLLATE BINARY, help VARCHAR(255) DEFAULT NULL COLLATE BINARY, required BOOLEAN NOT NULL, verify BOOLEAN DEFAULT NULL, CONSTRAINT FK_319B9E704584665A FOREIGN KEY (product_id) REFERENCES products (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
