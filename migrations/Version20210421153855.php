 ...
 */
final class Version20210421153855 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__attributes AS SELECT id, product_id, name, type, required FROM attributes');
        $this->addSql('DROP TABLE attributes');
        $this->addSql('CREATE TABLE attributes (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, product_id INTEGER DEFAULT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, type VARCHAR(64) NOT NULL COLLATE BINARY, required BOOLEAN NOT NULL, label VARCHAR(255) DEFAULT NULL, help VARCHAR(255) DEFAULT NULL, CONSTRAINT FK_319B9E704584665A FOREIGN KEY (product_id) REFERENCES products (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO attributes (id, product_id, name, type, required) SELECT id, product_id, name, type, required FROM __temp__attributes');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__attributes AS SELECT id, product_id, name, type, required FROM attributes');
        $this->addSql('DROP TABLE attributes');
        $this->addSql('CREATE TABLE attributes (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, product_id INTEGER DEFAULT NULL, name VARCHAR(255) NOT NULL, type VARCHAR(64) NOT NULL, required BOOLEAN NOT NULL)');
        $this->addSql('INSERT INTO attributes (id, product_id, name, type, required) SELECT id, product_id, name, type, required FROM __temp__attributes');
        $this->addSql('DROP TABLE __temp__attributes');
        $this->addSql('CREATE INDEX IDX_319B9E704584665A ON attributes (product_id)');
        $this->addSql('DROP INDEX IDX_46FD940392FCEA00');
