 ...
 */
final class Version20210418190213 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE orders (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, name VARCHAR(128) NOT NULL COLLATE BINARY, email VARCHAR(64) NOT NULL COLLATE BINARY, status VARCHAR(32) NOT NULL)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__orders AS SELECT id, created_at, updated_at, name, email, status FROM orders');
        $this->addSql('DROP TABLE orders');
        $this->addSql('CREATE TABLE orders (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, name VARCHAR(128) NOT NULL, email VARCHAR(64) NOT NULL, status VARCHAR(32) DEFAULT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO orders (id, created_at, updated_at, name, email, status) SELECT id, created_at, updated_at, name, email, status FROM __temp__orders');
        $this->addSql('DROP TABLE __temp__orders');
        $this->addSql('DROP INDEX IDX_B3BA5A5A61220EA6');
