 ...
 */
final class Version20210420173348 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__attributes AS SELECT id, product_id, name, type, required FROM attributes');
        $this->addSql('DROP TABLE attributes');
        $this->addSql('CREATE TABLE attributes (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL, type VARCHAR(64) NOT NULL, required BOOLEAN NOT NULL, product_id INTEGER NOT NULL)');
        $this->addSql('INSERT INTO attributes (id, product_id, name, type, required) SELECT id, product_id, name, type, required FROM __temp__attributes');
        $this->addSql('DROP TABLE __temp__attributes');
        $this->addSql('CREATE INDEX IDX_319B9E704584665A ON attributes (product_id)');
        $this->addSql('DROP INDEX IDX_2530ADE68D9F6D38');
