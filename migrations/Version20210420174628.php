 ...
 */
final class Version20210420174628 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE attributes (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, product_id INTEGER DEFAULT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, type VARCHAR(64) NOT NULL COLLATE BINARY, required BOOLEAN NOT NULL, CONSTRAINT FK_319B9E704584665A FOREIGN KEY (product_id) REFERENCES products (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
