 ...
 */
final class Version20210418091524 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE orders ADD COLUMN name VARCHAR(128)');
        $this->addSql('ALTER TABLE orders ADD COLUMN email VARCHAR(64)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE INDEX IDX_2530ADE68D9F6D38 ON order_product (order_id)');
        $this->addSql('CREATE INDEX IDX_2530ADE64584665A ON order_product (product_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__orders AS SELECT id, created_at, updated_at FROM orders');
        ...
        $this->addSql('INSERT INTO orders (id, created_at, updated_at) SELECT id, created_at, updated_at FROM __temp__orders');
